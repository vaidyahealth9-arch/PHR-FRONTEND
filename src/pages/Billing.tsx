  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between px-1">
        ...
        <span className="text-xs font-semibold text-slate-400">{bills.length} total</span>
      </div>
        ...
        <div className="space-y-3">
          {bills.map((bill, idx) => {
            ...
            return (
              ...
              >
                {/* Status bar */}
                <div className={`h-1 w-full ${statusConfig.bar} opacity-60`} />
                ...
                <div className="p-5 space-y-4">
                  <div className="flex justify-between items-start">
                    <div className="space-y-1">
                      ...
                      <h4 className="text-xl font-black text-slate-900 group-hover:text-primary-700 transition-colors">
                        {formatCurrency(bill.netAmount)}
                      </h4>
                    </div>
                    <div className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl ${statusConfig.bg} ${statusConfig.color}`}>
                  ...
                  <div className="grid grid-cols-2 gap-4 py-3 border-y border-dashed border-slate-100">
                    <div>
                      <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mb-0.5">Patient</p>
                      <p className="text-xs font-bold text-slate-700 truncate">{bill.patientName || 'Primary Member'}</p>
                    </div>
                    <div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="w-7 h-7 rounded-full bg-slate-50 flex items-center justify-center text-slate-300 group-hover:bg-primary-100 group-hover:text-primary-700 transition-all">
