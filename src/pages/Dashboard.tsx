    ...
    >
          ...
          {menuItems.map((item, index) => (
            ...
            >
              <div className="h-full p-4 sm:p-6 flex flex-col justify-between relative gap-3">
                <div
                  className={`w-11 h-11 bg-slate-100 group-hover:bg-white rounded-xl flex items-center justify-center shadow-sm group-hover:shadow-medium group-hover:-translate-y-1 transition-all duration-300`}
                >
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-slate-500 text-[11px] sm:text-xs font-medium leading-tight break-words">
                    {item.description}
                  </p>
                </div>
              </div>
      ...
      <section className="space-y-3">
        <div className="flex items-center justify-between px-1">
          ...
          <Link to="/records" className="text-xs font-semibold text-primary-700 hover:text-primary-800">
            See all
          </Link>
        </div>
